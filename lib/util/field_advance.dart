...
/// Validation helpers for numeric field formats (used by tests and forms).
class FieldComplete {
  FieldComplete._();
...
/// Mixin retained for screen compatibility. Focus advances only on Enter
/// ([TextField.onSubmitted] / [TextFormField.onFieldSubmitted]).
